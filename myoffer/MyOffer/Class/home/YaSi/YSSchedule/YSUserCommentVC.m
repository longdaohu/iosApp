...
@interface YSUserCommentVC ()<UITableViewDataSource,UITableViewDelegate>
@property(nonatomic,strong)UITableView *tableView;
@property(nonatomic,strong)NSArray *items;

@end

@implementation YSUserCommentVC
...
- (void)viewDidLoad {
    ...
    new_frame.size.width = self.view.bounds.size.width - 40;
...
- (void)caseQuit{
    ...
    WeakSelf;
    UIAlertController *alert = [UIAlertController alertWithTitle:nil  message:@"还未提交评价，是否退出？" actionWithCancelTitle:@"是" actionWithCancelBlock:^{
        [weakSelf hide];
    } actionWithDoneTitle:@"否" actionWithDoneHandler:^{
...
- (void)dealloc{
    ...
    KDClassLog(@"日历 + YSUserCommentVC + dealloc");
}
