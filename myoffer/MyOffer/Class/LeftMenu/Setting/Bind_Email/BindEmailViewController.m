...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    [MobClick beginLogPageView:@"page绑定邮箱"];
...
- (void)viewWillDisappear:(BOOL)animated
{
    ...
    [MobClick endLogPageView:@"page绑定邮箱"];
...
-(BOOL)checkTextField
{
    ...
    {
        AlerMessage(_EmailTextField.placeholder);
        
        return NO;
    }
    else if (![self validateEmail:_EmailTextField.text]) {
      
        AlerMessage(GDLocalizedString(@"Bind-emailError"));
