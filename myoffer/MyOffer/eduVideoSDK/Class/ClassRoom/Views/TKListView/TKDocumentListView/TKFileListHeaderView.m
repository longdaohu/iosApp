...
@interface TKFileListHeaderView() {
...
@implementation TKFileListHeaderView
...
- (void)classFileButtonClick{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(fileType:)]) {
        [self.delegate fileType:(ClassFileType)];
    }
...
- (void)systemFileButtonClick{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(fileType:)]) {
        [self.delegate fileType:(SystemFileType)];
    }
}
...
- (void)nameSortBtnClick:(UIButton *)sender{
    ...
    switch (sender.tag) {
        case Sort_Ascending:
        {
            sender.tag = Sort_Descending;
            _typeSortBtn.tag = Sort_None;
            _timeSortBtn.tag = Sort_None;
            
            if (self.delegate && [self.delegate respondsToSelector:@selector(nameSort:)]) {
                [self.delegate nameSort:Sort_Descending];
        ...
        case Sort_None:
        {
            sender.tag = Sort_Ascending;
            _typeSortBtn.tag = Sort_None;
            _timeSortBtn.tag = Sort_None;
            
            if (self.delegate && [self.delegate respondsToSelector:@selector(nameSort:)]) {
                [self.delegate nameSort:Sort_Ascending];
...
- (void)typeSortBtnClick:(UIButton *)sender{
    switch (sender.tag) {
        ...
        case Sort_None:
        {
            ...
            _timeSortBtn.tag = Sort_None;
            if (self.delegate && [self.delegate respondsToSelector:@selector(typeSort:)]) {
                [self.delegate typeSort:Sort_Ascending];
    ...
    switch (sender.tag) {
        case Sort_Ascending:
        {
            ...
            if (self.delegate && [self.delegate respondsToSelector:@selector(timeSort:)]) {
                [self.delegate timeSort:Sort_Descending];
        ...
        case Sort_None:
        {
            ...
            _nameSortBtn.tag = Sort_None;
            if (self.delegate && [self.delegate respondsToSelector:@selector(timeSort:)]) {
                [self.delegate timeSort:Sort_Ascending];
