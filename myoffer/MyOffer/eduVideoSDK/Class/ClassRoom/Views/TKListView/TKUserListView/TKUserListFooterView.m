...
@interface TKUserListFooterView()<UIGestureRecognizerDelegate,UITextFieldDelegate,TKUserListToolViewDelegate>
{
    NSInteger _totalNum;
...
@implementation TKUserListFooterView
