...
@property (nonatomic, assign) PageShowType pageShowType;
...
- (void)showOnView:(UIButton *)view totalPages:(int)totalPages pageShowType:(PageShowType)type
{
...
- (void)initContent
{
    ...
    self.contentView = ({
        ...
        view.image = [UIImage resizedImageWithName:ThemeKP(@"cameraToolToolbarImage")];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{{
    ...
    NSString *lineViewColor = self.pageShowType == DocumentPageShow?ThemeKP(@"cameraLineColor"):ThemeKP(@"cameraLineColor");
    
    NSString *titleLabelColor = self.pageShowType == DocumentPageShow?ThemeKP(@"titleColor"):ThemeKP(@"titleColor");
